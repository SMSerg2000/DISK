...
| Version | Changes |
|---------|---------|
| **3.0.4** | Brand-new drives (< 24h uptime): life forecast now shows "too early to estimate" instead of silently hiding the line — early writes (factory test + OS install) would skew the extrapolation |
